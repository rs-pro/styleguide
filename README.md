...
Степень поддержки мобильных броузеров зависит от того, разрабатывается ли мобильная версия сайта

### Десктоп версия сайта

| Броузер       | Версия | IOS | Android | Коммент     | Доля |
|---------------|--------|-----|---------|-------------|------|
| Chrome        |        |     |         |             |      |
| Firefox       |        |     |         |             |      |
| Safari        |        |     |         |             |      |
...
### Мобильная или responsive-320 версия сайта
...
* F  - Броузер не поддерживается.
* -  - Броузер не доступен (не существует) для этой платформы.
