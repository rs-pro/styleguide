...
* Отдельный макет где показанно как будут выглядеть заголовки(h1-h6), списки(ol, ul), текст в параграфе(p), активные элементы (ссылки, кнопоки) с наведенным/активным состоянием
