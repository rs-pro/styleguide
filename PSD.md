...
* Контрольные изображения JPEG каждой страницы из макета (служат для контроля что все корректно открылось). Должны иметь разумные понятные названия (не файл1 файл2)
* Если в макете несколько страниц, они должны быть в отдельных подписанных папках. Подписи должны совпадать с именем контрольного файла из п1.
